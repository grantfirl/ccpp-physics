...
!! | gq0_cloud_liq_nc           | cloud_droplet_number_concentration_updated_by_physics                       | number concentration of cloud droplets updated by physics                                   | kg-1          |    2 | real       | kind_phys | in     | F        |
!! | gq0_cloud_ice_nc           | ice_number_concentration_updated_by_physics                                 | number concentration of ice updated by physics                                              | kg-1          |    2 | real       | kind_phys | in     | F        |
...
!! | ncpi                       | local_cloud_ice_number_concentration                                        | cloud ice number concentration local to physics                                             | kg-1          |    2 | real       | kind_phys | inout  | F        |
!! | ncpl                       | local_cloud_droplet_number_concentration                                    | cloud droplet number concentration local to physics                                         | kg-1          |    2 | real       | kind_phys | inout  | F        |
...
subroutine shoc_run (ix, nx, nzm, shocaftcnv, mg3_as_mg2, imp_physics, imp_physics_gfdl, imp_physics_zhao_carr,              &
    ...
    con_fvirt, gq0_cloud_ice, gq0_rain, gq0_snow, gq0_graupel, gq0_cloud_liq_nc, gq0_cloud_ice_nc, dtp, me, prsl, phii, phil,&
    u, v, omega, rhc, supice, pcrit, cefac, cesfac, tkef1, dis_opt, hflx, evap, prnum,                                       &
    skip_macro, qrn, qsnw, clw_ice, clw_liquid, gq0_cloud_liquid, ncpi, ncpl, gt0, gq0_water_vapor, cld_sgs, tke, tkh,       &
    wthv_sec, errmsg, errflg)
...
! Initialize CCPP error handling variables
    ...
    !    do k=1,nzm
    !      do i=1,nx
    !        gq0_cloud_liq_nc(i,k) = ncpl(i,k)
    !        gq0_cloud_ice_nc(i,k) = ncpi(i,k)
    !      enddo
    !    enddo
    ! endif
