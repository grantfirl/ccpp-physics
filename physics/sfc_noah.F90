...
!     local Variables
      ...
      do i=1, im
        if (flag_lsm(i)) then  
          ...
          write(*,*) i,'smc = ',smc(i,:)
          write(*,*) i,'swc = ',swc(i,:)
          write(*,*) i,'snowhk = ',snowhk(i)
          write(*,*) i,'sneqv = ',sneqv(i)
          write(*,*) i,'chk = ',chk(i)
          write(*,*) i,'eta = ',eta
          write(*,*) i,'sheat = ',sheat(i)
          write(*,*) i,'eta_k = ',eta_kinematic(i)
          write(*,*) i,'ec = ',ec(i)
          write(*,*) i,'edir = ',edir(i)
          write(*,*) i,'ett = ',ett(i)
          write(*,*) i,'esnow = ',esnow(i)
          write(*,*) i,'etp = ',etp(i)
          write(*,*) i,'ssoil = ',ssoil(i)
          write(*,*) i,'flx1 = ',flx1(i)
          write(*,*) i,'flx2 = ',flx2(i)
          write(*,*) i,'flx3 = ',flx3(i)
          write(*,*) i,'sncovr = ',sncovr(i)
          write(*,*) i,'runoff1 = ',runoff1(i)
          write(*,*) i,'runoff2 = ',runoff2(i)
          write(*,*) i,'soilm = ',soilm(i)
          write(*,*) i,'qsurf = ',qsurf(i)
          write(*,*) i,'snotime = ',snotime(i)
          write(*,*) i,'smcwlt = ',smcwlt(i)
          write(*,*) i,'smcref = ',smcref(i)
          write(*,*) i,'smcmax = ',smcmax(i)
          if (errflg > 0) return
        endif
      end do
